...
public class ModelClass  {
 ...
 String[] categorias = {"Oposiciones", "General", "Geografia" , "Historia", "Arte", "Deportes"};
  ...
  */
 public ModelClass(String question, String cA, String cB, String cC, String cD, String ans) {
  Question = question;
  this.cA = cA;
  this.cB = cB;
  this.cC = cC;
